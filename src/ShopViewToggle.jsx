...
export default function ShopViewToggle({
  ...
  return (
    <div className={`flex justify-center ${className}`}>
      <div
        className={`relative inline-flex w-full items-center rounded-full border-2 border-black bg-white p-1 shadow-[4px_4px_0px_rgba(0,0,0,0.12)] ${
        ...
        {["links", "shop"].map((mode) => {
          ...
          return (
            <button
              ...
              className={`relative z-10 flex-1 min-w-0 basis-0 rounded-full text-center font-black uppercase tracking-[0.18em] transition-colors duration-200 ${
